...
(() => {
  ...
  function ensureModal() {
    ...
    document.body.insertAdjacentHTML('beforeend', `<section class="catalog-demo-quote" role="dialog" aria-modal="true" aria-label="Solicitar orçamento"><form class="cdq-box"><div class="cdq-head"><div><p style="margin:0 0 5px;color:#4f46e5;font-weight:800;font-size:12px;letter-spacing:.08em">ORÇAMENTO ESTIMADO</p><h2>Monte sua solução</h2></div><button class="cdq-close catalog-liquid-button" type="button" aria-label="Fechar">×</button></div><p>Escolha os adicionais e compartilhe o resumo pelo canal desejado.</p><div class="cdq-options"></div><div class="cdq-total"><span>Estimativa inicial</span><strong data-total>—</strong></div><textarea class="cdq-summary" readonly aria-label="Resumo do orçamento"></textarea><div class="cdq-share"><a class="catalog-liquid-button" data-wa target="_blank" rel="noreferrer">WhatsApp</a><a class="catalog-liquid-button" data-mail>Enviar por e-mail</a><button class="catalog-liquid-button" type="button" data-copy>Copiar resumo</button><button class="catalog-liquid-button" type="button" data-code>Copiar código</button></div></form></section>`);
