...
(() => {
  ...
  function editableTextNodes() {
    ...
    nodes.forEach(textNode => {
      ...
      editor.addEventListener('click', event => { if (!editMode.texts) return; event.preventDefault(); event.stopPropagation(); editor.focus(); });
    });
  }
  ...
  function updateEditMode() {
    ...
    document.querySelector('[data-edit-lock="texts"]')?.replaceChildren(document.createTextNode(editMode.texts ? '🔓 Textos' : '🔒 Textos'));
    document.querySelector('[data-edit-lock="buttons"]')?.replaceChildren(document.createTextNode(editMode.buttons ? '🔓 Botões' : '🔒 Botões'));
  }
